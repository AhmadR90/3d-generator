...
const Hero = () => {
  ...
  return (
    <div className="relative min-h-screen flex items-center bg-black justify-center overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-10 flex flex-col justify-center items-center text-center lg:text-left lg:items-start w-full lg:w-[40vw] max-w-2xl space-y-6 py-12 lg:py-0 px-4 sm:px-6 lg:px-8">
        <motion.div
